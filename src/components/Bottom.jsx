            ...
            <div className='bottomContainer'>
                ...
                <div className='others'>
                    ...
                    <ul className='sitemap'>
                        <h6>Sitemap</h6>
                        { loggedIn ? <><Link to='/posts' className='btmLinks'>Posts</Link><Link to='/topics' className='btmLinks'>Topics</Link><Link to='/' className='btmLinks'>Home</Link></> : <><Link to='/log-in' className='btmLinks'>Log In</Link><Link to='/sign-up' className='btmLinks'>Sign Up</Link></> }
                    </ul>
                </div>  
            </div>
        </>
